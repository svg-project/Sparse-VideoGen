...
from .attention import (
    Cosmos_SVG_AttnProcessor2_0,
    Cosmos_SAPAttn_Processor,
...
def replace_cosmos_attention(
    ...
    if pattern == "SVG":
        AttnModule = Cosmos_SVG_AttnProcessor2_0
        ...
        if attention_backend == "flexattn":
            ...
            print(block_mask.to_string(grid_size=(20, 20)))
        ...
        AttnModule = Cosmos_SAPAttn_Processor
