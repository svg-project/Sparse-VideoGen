...
class TextEncoder(nn.Module):
    def __init__(
        ...
        if self.use_template:
            ...
            assert "{}" in str(self.prompt_template["template"]), "`prompt_template['template']` must contain a placeholder `{}` for the input text, " f"got {self.prompt_template['template']}"
        ...
        if self.use_video_template:
            ...
            assert "{}" in str(self.prompt_template_video["template"]), (
                "`prompt_template_video['template']` must contain a placeholder `{}` for the input text, " f"got {self.prompt_template_video['template']}"
            )
