...
if __name__ == "__main__":
    ...
    print(
        "LM dashscope result -> zh", dashscope_result.prompt
    ...
    print(
        "LM dashscope en result -> zh", dashscope_result.prompt
    )  # dashscope_result.system_prompt)
    ...
    print(
        "VL dashscope result -> zh", dashscope_result.prompt
    )  # , dashscope_result.system_prompt)
    dashscope_result = dashscope_prompt_expander(
    ...
    print(
        "VL dashscope en result -> zh", dashscope_result.prompt
    )  # , dashscope_result.system_prompt)
    dashscope_result = dashscope_prompt_expander(
    ...
    print(
        "VL qwen vl en result -> zh", qwen_result.prompt
