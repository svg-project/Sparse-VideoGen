...
if __name__ == "__main__":
    ...
    print("LM dashscope result -> zh", dashscope_result.prompt)  # dashscope_result.system_prompt)
    ...
    print("LM dashscope en result -> zh", dashscope_result.prompt)  # dashscope_result.system_prompt)
    dashscope_result = dashscope_prompt_expander(en_prompt, tar_lang="en")
    print("LM dashscope en result -> en", dashscope_result.prompt)  # dashscope_result.system_prompt)
    # # test qwen api
    ...
    print("LM qwen result -> zh", qwen_result.prompt)  # qwen_result.system_prompt)
    ...
    print("LM qwen en result -> zh", qwen_result.prompt)  # , qwen_result.system_prompt)
    ...
    print("VL dashscope result -> zh", dashscope_result.prompt)  # , dashscope_result.system_prompt)
    ...
    print("VL dashscope en result -> zh", dashscope_result.prompt)  # , dashscope_result.system_prompt)
    dashscope_result = dashscope_prompt_expander(en_prompt, tar_lang="en", image=image, seed=seed)
    print("VL dashscope en result -> en", dashscope_result.prompt)  # , dashscope_result.system_prompt)
    # test qwen api
    ...
    print("VL qwen result -> zh", qwen_result.prompt)  # , qwen_result.system_prompt)
    ...
    qwen_result = qwen_prompt_expander(en_prompt, tar_lang="zh", image=image, seed=seed)
    print("VL qwen vl en result -> zh", qwen_result.prompt)  # , qwen_result.system_prompt)
